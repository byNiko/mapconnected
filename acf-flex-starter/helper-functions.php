...
function get_acf_button($button_arr) {
	$color = $button_arr['button_template']['color'];
	$type = $button_arr['button_template']['type'];
	$link = $button_arr['button_template']['link'];

	$htmlLink = get_acf_link($link, "button button--$color button--$type");
	print_r($htmlLink);
